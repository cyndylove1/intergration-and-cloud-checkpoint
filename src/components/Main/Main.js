  ...
  return (
    <div>
        <div className='main-body'>
            ...
            <img src={'hero-machine.webp'} className='img' alt=''/>
        ...
        <div className='main-body2'>
            ...
            <img src={'img-automation_studio.webp'} className='imgs' alt=''/>
        ...
        <div className='main-body3'>
            <img src={'customers-find.webp'} className='img3' alt=''/>
        ...
        <div className='main-body5'>
            <img src={'correct-choices.webp'} className='img5' alt=''/>
        ...
        <div className='main-body6'>
            <div className='body-content6'>
                ...
                <img src={'experts.webp'} className='img6' alt=''/>
